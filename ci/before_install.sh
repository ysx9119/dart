...
sudo add-apt-repository -qq --yes ppa:ubuntu-toolchain-r/test
sudo apt-get -qq update
sudo apt-get -qq --yes install gcc-4.8 g++-4.8
sudo apt-get -qq --yes autoremove
sudo update-alternatives -qq --install /usr/bin/gcc gcc /usr/bin/gcc-4.8 50
sudo update-alternatives -qq --install /usr/bin/g++ g++ /usr/bin/g++-4.8 50
...
sudo add-apt-repository -qq --yes ppa:libccd-debs/ppa
sudo add-apt-repository -qq --yes ppa:fcl-debs/ppa
sudo add-apt-repository -qq --yes ppa:dartsim/ppa
sudo apt-get -qq update
